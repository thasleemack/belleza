...
class Addreview extends StatefulWidget {
  ...
  String userName;
   ...
   Addreview({super.key,required this.userId, required this.userName,                                                                                                                                                               });
            ...
            child: IconButton(
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) =>  Reviews(userId: widget.userId, userName: widget.userName,)));
                },
                  icon: const Icon(
